...
public class VerificationMailService {
    ...
    public void sendResetPasswordEmail(String to, String resetLink, Integer activeDuration)  {
        ...
        String html = """
            ...
            """.formatted(html_single_lang, greeting, bodyLabel, resetLink, footer, html_footer);
    ...
    public void sentVerificationEmail(String to, String code, Integer activeDuration) {
        Locale locale = LocaleContextHolder.getLocale();
