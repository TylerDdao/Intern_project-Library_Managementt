...
public class CreatePostService {
    ...
    public PostResponse createPost(PostRequest request){
        Post post = new Post();
        Book book = bookRepository.findById(request.getBook()).orElseThrow(()->new RuntimeException(messageSource.getMessage("error.book.not.found", null, LocaleContextHolder.getLocale())));
